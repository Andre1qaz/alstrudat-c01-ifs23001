...
public class MobilKBT {
    ...
    public void tambahMobil() {
        ...
        DataMobilKBT mobilBaru = new DataMobilKBT(id, nama, jenis, dayaListrik, kapasitasBaterai, kapasitasPenumpang,
                jangkauan);
    ...
    public void sortMobilByDaya() {
        LinkedListHelper.sortList(daftarMobil, (a, b) -> {
            if (a.getDayaListrik() > b.getDayaListrik())
                return 1;
            else if (a.getDayaListrik() < b.getDayaListrik())
                return -1;
            else
                return 0;
        });
    ...
    public void sortMobilByKapasitasBaterai() {
        LinkedListHelper.sortList(daftarMobil, (a, b) -> {
            if (a.getKapasitasBaterai() > b.getKapasitasBaterai())
                return 1;
            else if (a.getKapasitasBaterai() < b.getKapasitasBaterai())
                return -1;
            else
                return 0;
        });
